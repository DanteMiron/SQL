-- 1.Cuantos usuarios tenemos con cuentas @google.com -- Tip: count,like
SELECT
    COUNT(*)
FROM
    users
...
FROM 
	users
WHERE 
	country = 'Iceland' AND (last_connection LIKE '112%' OR last_connection LIKE '28%' OR last_connection LIKE '112%');
